 ...
 ********************************************************************************/
//
// BIM IFC export alternate UI library: this library works with 
// Autodesk(R) Revit(R) to provide an alternate user interface 
// for the export of IFC files from Revit.
// Copyright (C) 2016  Autodesk, Inc.
// ------------------------------------------------------------------------------
// Альтернативная библиотека пользовательского интерфейса экспорта BIM IFC: 
// эта библиотека работает с Autodesk(R) Revit(R) и предоставляет альтернативный 
// пользовательский интерфейс для экспорта файлов IFC из Revit.
// Авторские права (C) 2016 Autodesk, Inc.
//
// Эта библиотека является свободным программным обеспечением; 
// вы можете распространять его и/или
// изменяем его в соответствии с условиями GNU Lesser General Public
